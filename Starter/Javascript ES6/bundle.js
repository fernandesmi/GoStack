...
var newerArr = arr.map(function (item) {
  return item * 2;
});
console.log(newerArr); //const testeObj = () => { nome: 'Diego'} ====> não funciona porque as chaves são usadas para o corpo da funcão e confunde com o retorno de objeto
...
console.log(testeObj()); //Valores padrãoptimize
// function newerSoma(a = 3,b = 6) {
//   return a + b;
// }

var newerSoma = function newerSoma() {
